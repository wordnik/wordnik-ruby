...
module PartnersMethods
  ...
  #
  def create_glossary(contentProvider, *args)
    http_method = :post
  ...
  #
  def update_glossary(contentProvider, permalinkId, *args)
    http_method = :put
    path = '/partners/{contentProvider}/glossary/{permalinkId}'
    path.sub!('{contentProvider}', contentProvider)
    path.sub!('{permalinkId}', permalinkId)
  ...
  #
  def add_glossary_entry(contentProvider, permalinkId, *args)
    http_method = :post
    path = '/partners/{contentProvider}/glossary/{permalinkId}/entries'
    path.sub!('{contentProvider}', contentProvider)
    path.sub!('{permalinkId}', permalinkId)
  ...
  # Removes a GlossaryEntry object from the specified Glossary.
  #
  def delete_glossary_entries(contentProvider, permalinkId, *args)
    http_method = :post
