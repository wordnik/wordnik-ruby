...
module UserMethods
  ...
  #
  def update_user_profile(username, *args)
    http_method = :put
    path = '/user/{username}/profile'
    path.sub!('{username}', username)
  ...
  #
  def update_user_settings(username, *args)
    http_method = :put
    path = '/user/{username}/settings'
    path.sub!('{username}', username)
  ...
  #
  def comment_on_user(username, *args)
    http_method = :post
  ...
  #
  def update_comment_on_user(username, *args)
    http_method = :put
    path = '/user/{username}/comment'
    path.sub!('{username}', username)
  ...
  def add_subscription(user, objectType, objectIdentifier, *args)
    ...
    path.sub!('{user}', user)
    path.sub!('{objectType}', objectType)
    path.sub!('{objectIdentifier}', objectIdentifier)
