...
module WordMethods
  ...
  #
  def get_examples_post(word, *args)
    http_method = :post
    path = '/word/{word}/examples'
    path.sub!('{word}', word)
  ...
  # Deprecated
  #
  def add_word_relationship_internal(word, *args)
    http_method = :post
  ...
  #
  def update_comment_on_word(word, *args)
    http_method = :put
    path = '/word/{word}/comment'
    path.sub!('{word}', word)
