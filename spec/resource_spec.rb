...
describe Wordrabbit::Resource do
  ...
  before(:each) do
    ...
    @resource = Wordrabbit::Resource.new(@default_params)
  end
  ...
  describe "initialization" do
    ...
    it "sets endpoints" do
      ...
      @resource.endpoints.first.class.should == Wordrabbit::Endpoint
    end
  ...
  describe "auto-generated methods" do
    ...
    it "builds requests but doesn't run them if :request_only is passed" do
      @request = Wordrabbit.word.get_word('dynamo', :request_only => true)
      @request.class.should == Wordrabbit::Request
    end

    it "runs requests and returns their body if :request_only is absent" do
      @response_body = Wordrabbit.word.get_word('dynamo')
    ...
    it "allows the same auto-generated method to be called with different parameters" do
      ...
      request2 = Wordrabbit.word_list.get_word_list_by_id('cat', :request_only => true)
    ...
    context "argument handling" do
      ...
      before(:each) do
         @request = Wordrabbit.word.get_examples('dynamo', :skip => 2, :limit => 10, :request_only => true)
       end
       ...
       it "puts key-value arguments in the request body instead of the query params for POSTs and PUTs" do
         body = {
           :name => "Wordrabbit Ruby Test List #{RAND}",
           :description => 'This is created by the test suite.',
           :type => 'PUBLIC',
           :user_id => Wordrabbit.configuration.user_id,
           :request_only => true
         }
         @request = Wordrabbit.word_lists.create_word_list(body, :request_only => true)
    ...
    context "response transmogrification" do
      ...
      it "converts definitions response into an array of definition objects" # do
        # defs = Wordrabbit.word.get_definitions('boogaloo')
        # defs.should be_an(Array)
        # defs.first.should be_a(Wordrabbit::Definition)
      # end
